...
Pod::Spec.new do |s|
  s.name             = 'NextomeLegacy_x86'
  s.version          = '1.0.0'
  s.summary          = 'Old Sdk third party module'
...
Old Sdk third party module
  ...
  s.ios.vendored_frameworks = 'SDK/x86/NextomeLegacy/nextomesdklib.framework'
end
